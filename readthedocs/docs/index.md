...
**Steam Auto Shutdown** is a CLI tool that monitors network traffic and shuts down the computer when downloads finish.

It is designed to replicate the functionality of [Steam Auto Shutdown](https://github.com/diogomartino/steam-auto-shutdown) but with a focus on cross-platform support and command-line flexibility.
